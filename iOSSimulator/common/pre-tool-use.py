#!/usr/bin/env python3
# Generated from common/pre-tool-use.py by scripts/sync-plugin-common.py. Do not edit this copy; edit common/pre-tool-use.py and rerun scripts/sync-plugin-common.py.
