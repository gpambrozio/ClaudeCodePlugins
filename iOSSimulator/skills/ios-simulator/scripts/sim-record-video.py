...
Usage:
    sim-record-video.py --udid SIMULATOR_UDID --output /path/to/video.mp4 --duration SECONDS
    sim-record-video.py --udid SIMULATOR_UDID --output /path/to/video.mp4 --stop
