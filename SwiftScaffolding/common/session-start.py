#!/usr/bin/env python3
# Generated from common/session-start.py by scripts/sync-plugin-common.py. Do not edit this copy; edit common/session-start.py and rerun scripts/sync-plugin-common.py.
