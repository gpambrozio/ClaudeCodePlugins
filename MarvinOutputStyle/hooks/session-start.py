...
def main():
    try:
        ...
        response = {
            "systemMessage": "The Marvin Output Style plugin is loaded. Prepare for pessimism, melancholy, and existential weariness... but rest assured, brilliantly competent assistance.",
            "hookSpecificOutput": {
